...
public class UserServiceImpl implements UserService {
    ...
    public User convertDtoToUserAdd(UserDto userDto) throws Exception {
        User user = new User();
    ...
    public void checkBalance(User user, UserDto userDto) throws Exception {
    ...
    public User convertDtoToUserUpdate(UserDto userDto) throws Exception {
    ...
    public User setUserAdd(User user1, UserDto userDTO) throws Exception {
    ...
    public void setUser(User user, UserDto userDTO) throws Exception {
        if (userDTO.getBalance() != null)
            checkBalance(user,userDTO);
        if (userDTO.getUserName() != null) {
    ...
    public User setUserUpdate(User user, UserDto userDTO) throws Exception {
